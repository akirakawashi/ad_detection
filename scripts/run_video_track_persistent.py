...
DEFAULT_MODEL = "models/trained/yolo11m_img960_antifp_cvat_corrections_ft_v1/best.pt"
DEFAULT_VIDEO = "test_rotated_ccw_90.mp4"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Directory for outputs. Defaults to output_video/<model_name>_<video_stem>_track_persist<N>.",
    )
...
def main() -> None:
    ...
    output_dir = (
        ...
        if args.output_dir
        else project_root / "output_video" / run_name
    )
