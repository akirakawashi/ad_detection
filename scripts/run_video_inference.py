...
DEFAULT_MODEL = "models/trained/yolo11m_pretrained_img960_b10_antifp_full_v1/best.pt"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Directory for output files. Defaults to output_video/<model_name>_<video_stem>.",
    )
